...
class TestFeeCalculator(unittest.TestCase):
    ...
    def test_friday_rush(self):
        ...
        """
        example_delivery = {"cart_value": 790, "delivery_distance": 2235, "number_of_items": 4, "time": "2024-01-26T15:30:00Z"}
        response = self.client.post("/", json=example_delivery)
        self.assertEqual (response.status_code, 200)
    ...
    def test_no_friday_rush_after_end(self):
        ...
        """
        example_delivery = {"cart_value": 790, "delivery_distance": 2235, "number_of_items": 4, "time": "2024-01-26T19:00:01Z"}
        response = self.client.post("/", json=example_delivery)
        self.assertEqual (response.status_code, 200)
        self.assertEqual (response.json(), {"delivery_fee": 710})
    ...
    def test_free_delivery(self):
        ...
        """
        example_delivery = {"cart_value": 20000, "delivery_distance": 2235, "number_of_items": 4, "time": "2024-01-26T15:30:00Z"}
        response = self.client.post("/", json=example_delivery)
        self.assertEqual (response.status_code, 200)
    ...
    def test_max_delivery_fee(self):
        ...
        """
        example_delivery = {"cart_value": 790, "delivery_distance": 50000, "number_of_items": 9, "time": "2024-01-26T15:30:00Z"}
        response = self.client.post("/", json=example_delivery)
        self.assertEqual (response.status_code, 200)
    ...
    def test_minimum_fee(self):
        ...
        """
        example_delivery = {"cart_value": 1000, "delivery_distance": 3, "number_of_items": 4, "time": "2024-01-15T15:30:00Z"}
        response = self.client.post("/", json=example_delivery)
        self.assertEqual (response.status_code, 200)
    ...
    def test_additional_delivery_distance_fee_1499_meters(self):
        ...
        """
        example_delivery = {"cart_value": 1000, "delivery_distance": 1499, "number_of_items": 4, "time": "2024-01-15T15:30:00Z"}
        response = self.client.post("/", json=example_delivery)
        self.assertEqual (response.status_code, 200)
    ...
    def test_additional_delivery_distance_fee_1500_meters(self):
        ...
        """
        example_delivery = {"cart_value": 1000, "delivery_distance": 1500, "number_of_items": 4, "time": "2024-01-15T15:30:00Z"}
        response = self.client.post("/", json=example_delivery)
        self.assertEqual (response.status_code, 200)
        self.assertEqual (response.json(), {"delivery_fee": 300})
    ...
    def test_additional_delivery_distance_fee_1501_meters(self):
        ...
        """
        example_delivery = {"cart_value": 1000, "delivery_distance": 1501, "number_of_items": 4, "time": "2024-01-15T15:30:00Z"}
        response = self.client.post("/", json=example_delivery)
        self.assertEqual (response.status_code, 200)
    ...
    def test_additional_item_fee_4_items(self):
        ...
        """
        example_delivery = {"cart_value": 1000, "delivery_distance": 200, "number_of_items": 4, "time": "2024-01-15T15:30:00Z"}
        response = self.client.post("/", json=example_delivery)
        self.assertEqual (response.status_code, 200)
        self.assertEqual (response.json(), {"delivery_fee": 100})
    ...
    def test_additional_item_fee_5_items(self):
        ...
        """
        example_delivery = {"cart_value": 1000, "delivery_distance": 200, "number_of_items": 5, "time": "2024-01-15T15:30:00Z"}
        response = self.client.post("/", json=example_delivery)
        self.assertEqual (response.status_code, 200)
    ...
    def test_additional_item_fee_13_items(self):
        ...
        """
        example_delivery = {"cart_value": 1000, "delivery_distance": 200, "number_of_items": 13, "time": "2024-01-15T15:30:00Z"}
        response = self.client.post("/", json=example_delivery)
        self.assertEqual (response.status_code, 200)
    ...
    def test_additional_item_fee_14_items(self):
        ...
        """
        example_delivery = {"cart_value": 1000, "delivery_distance": 200, "number_of_items": 14, "time": "2024-01-15T15:30:00Z"}
        response = self.client.post("/", json=example_delivery)
        self.assertEqual (response.status_code, 200)
    ...
    def test_non_valid_data(self):
        ...
        """
        example_delivery = {"cart_value": "value", "delivery_distance": 2235, "number_of_items": 4, "time": "2024-01-15T13:00:00Z"}
        response = self.client.post("/", json=example_delivery)
