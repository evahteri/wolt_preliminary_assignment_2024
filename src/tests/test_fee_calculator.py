...
class TestFeeCalculatorTotalFee(unittest.TestCase):
    ...
    def test_calculate_fee(self):
        """Test the function with test_config.py file with example delivery. Fee should be 7.10€
        """
    ...
    def test_calculate_fee_minimum_total_fee(self):
        ...
        total_fee = self.calculator.calculate_fee(delivery)
...
class TestFeeCalculatorCartValueSurcharge(unittest.TestCase):
    ...
    def test_minimum_cart_value_surcharge_is_right(self):
        ...
        """
        cart_value = 890
        surcharge = self.calculator.minimum_cart_value(cart_value=cart_value, min_cart_value=1000)
    ...
    def test_minimum_cart_value_no_surcharge(self):
        ...
        """
        cart_value = 1200
        surcharge = self.calculator.minimum_cart_value(cart_value=cart_value, min_cart_value=1100)
...
class TestFeeCalculatorDistanceSurcharge(unittest.TestCase):
    ...
    def test_delivery_distance_surcharge_min_fee(self):
        ...
        """
        surcharge = self.calculator.delivery_distance_fee(delivery_distance=100, 
    ...
    def test_delivery_distance_surcharge_base_fee_edge_equal(self):
        ...
        """
        surcharge = self.calculator.delivery_distance_fee(delivery_distance=1000, 
                                                          minimum_delivery_fee=100,
                                                          minimum_delivery_distance=500,
                                                          delivery_fee_for_additional_distance=100,
                                                          delivery_fee_for_the_first_km=200,
    ...
    def test_delivery_distance_surcharge_base_fee_edge_under(self):
        ...
        """
        surcharge = self.calculator.delivery_distance_fee(delivery_distance=999, 
                                                          minimum_delivery_fee=100,
                                                          minimum_delivery_distance=500,
                                                          delivery_fee_for_additional_distance=100,
                                                          delivery_fee_for_the_first_km=200,
    ...
    def test_delivery_distance_surcharge_base_fee_edge_over(self):
        ...
        """
        surcharge = self.calculator.delivery_distance_fee(delivery_distance=1001, 
                                                          minimum_delivery_fee=100,
                                                          minimum_delivery_distance=500,
                                                          delivery_fee_for_additional_distance=100,
                                                          delivery_fee_for_the_first_km=200,
    ...
    def test_delivery_distance_surcharge_additional_distance_surcharge(self):
        ...
        """
        surcharge = self.calculator.delivery_distance_fee(delivery_distance=1200, 
                                                          minimum_delivery_fee=100,
                                                          minimum_delivery_distance=500,
                                                          delivery_fee_for_additional_distance=100,
                                                          delivery_fee_for_the_first_km=200,
    ...
    def test_delivery_distance_surcharge_additional_distance_surcharge_edge_case_lower(self):
        ...
        """
        surcharge = self.calculator.delivery_distance_fee(delivery_distance=1499, 
                                                          minimum_delivery_fee=100,
                                                          minimum_delivery_distance=500,
                                                          delivery_fee_for_additional_distance=100,
                                                          delivery_fee_for_the_first_km=200,
    ...
    def test_delivery_distance_surcharge_additional_distance_surcharge_edge_case_equal(self):
        ...
        """
        surcharge = self.calculator.delivery_distance_fee(delivery_distance=1500, 
                                                          minimum_delivery_fee=100,
                                                          minimum_delivery_distance=500,
                                                          delivery_fee_for_additional_distance=100,
                                                          delivery_fee_for_the_first_km=200,
    ...
    def test_delivery_distance_surcharge_additional_distance_surcharge_edge_case_higher(self):
        ...
        """
        surcharge = self.calculator.delivery_distance_fee(delivery_distance=1501, 
                                                          minimum_delivery_fee=100,
                                                          minimum_delivery_distance=500,
                                                          delivery_fee_for_additional_distance=100,
                                                          delivery_fee_for_the_first_km=200,
...
class TestFeeCalculatorNumberOfItems(unittest.TestCase):
    ...
    def test_number_of_items_fee_no_surcharge_lower(self):
        ...
        """
        surcharge = self.calculator.number_of_items_fee(items_amount=3, 
    ...
    def test_number_of_items_fee_no_surcharge_equal(self):
        ...
        no surcharge should be added.
        """
        surcharge = self.calculator.number_of_items_fee(items_amount=4, 
                                                        product_amount_for_surcharge=4,
                                                        surcharge_fee=50,
                                                        bulk_amount=12,
                                                        bulk_charge_fee=120)
    ...
    def test_number_of_items_fee_no_surcharge_one_surcharge(self):
        ...
        """
        surcharge = self.calculator.number_of_items_fee(items_amount=5, 
                                                        product_amount_for_surcharge=4,
                                                        surcharge_fee=50,
                                                        bulk_amount=12,
                                                        bulk_charge_fee=120)
    ...
    def test_number_of_items_fee_no_bulk_multiple_surcharge(self):
        ...
        """
        surcharge = self.calculator.number_of_items_fee(items_amount=11, 
                                                        product_amount_for_surcharge=4,
                                                        surcharge_fee=50,
                                                        bulk_amount=12,
                                                        bulk_charge_fee=120)
    ...
    def test_number_of_items_fee_no_bulk_fee_when_equal(self):
        ...
        """
        surcharge = self.calculator.number_of_items_fee(items_amount=12, 
                                                        product_amount_for_surcharge=4,
                                                        surcharge_fee=50,
                                                        bulk_amount=12,
                                                        bulk_charge_fee=120)
    ...
    def test_number_of_items_fee_bulk_fee_when_over(self):
        ...
        """
        surcharge = self.calculator.number_of_items_fee(items_amount=13, 
                                                        product_amount_for_surcharge=4,
                                                        surcharge_fee=50,
                                                        bulk_amount=12,
                                                        bulk_charge_fee=120)
...
class TestFeeCalculatorRushHour(unittest.TestCase):
    ...
    def setUp(self):
        settings.ENVIRONMENT = 'test'
        self.test_rush_hours = [RushHours(
        day=4, start=time(15, 00, 00), end=time(19, 00, 00), fee=1.2 #friday 15-19, fee multiplier 1.2
        ),RushHours(
        day=0, start=time(9, 00, 00), end=time(12, 00, 00), fee=0.5 #monday 9-12, fee multiplier 0.5 (50% discount)
        )]
    ...
    def test_rush_hour_fee_rush_hour(self):
        ...
        """
        rush_hour_multiplier = self.calculator.rush_hour_fee(time="2024-01-19T15:00:20Z", 
    ...
    def test_rush_hour_fee_no_rush_hour(self):
        ...
        """
        rush_hour_multiplier = self.calculator.rush_hour_fee(time="2024-01-19T10:00:20Z", 
                                                             rush_hours=self.test_rush_hours)
    ...
    def test_rush_hour_fee_rush_hour_edge_case_below(self):
        ...
        """
        rush_hour_multiplier = self.calculator.rush_hour_fee(time="2024-01-19T14:59:59Z", 
                                                             rush_hours=self.test_rush_hours)
        self.assertEqual(rush_hour_multiplier, 1)
    ...
    def test_rush_hour_fee_rush_hour_edge_case_equal(self):
        ...
        """
        rush_hour_multiplier = self.calculator.rush_hour_fee(time="2024-01-19T15:00:00Z", 
                                                             rush_hours=self.test_rush_hours)
        self.assertEqual(rush_hour_multiplier, 1.2)
    ...
    def test_rush_hour_fee_rush_hour_edge_case_over(self):
        ...
        """
        rush_hour_multiplier = self.calculator.rush_hour_fee(time="2024-01-19T15:00:01Z", 
                                                             rush_hours=self.test_rush_hours)
        self.assertEqual(rush_hour_multiplier, 1.2)
    ...
    def test_rush_hour_fee_discount(self):
        ...
        """
        rush_hour_multiplier = self.calculator.rush_hour_fee(time="2024-01-29T11:00:00Z", 
                                                             rush_hours=self.test_rush_hours)
